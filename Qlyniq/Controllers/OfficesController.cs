...
namespace Qlyniq.Controllers
{
    public class OfficesController : Controller
    {
        ...
        {
            var qlyniqContext = _context.Offices.Include(o => o.Dean);
        ...
        {
            ViewData["DeanId"] = new SelectList(_context.Deans, "Id", "Id");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,DeanId,Budget")] Offices offices)
        {
            ...
            ViewData["DeanId"] = new SelectList(_context.Deans, "Id", "Id", offices.DeanId);
            return View(offices);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(uint id, [Bind("Id,Name,DeanId,Budget")] Offices offices)
        {
            if (id != offices.Id)
            {
                return NotFound();
