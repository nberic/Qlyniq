...
namespace Qlyniq.Controllers
{
    public class FilesController : Controller
    {
        ...
        {
            ViewData["CreatorId"] = new SelectList(_context.Employees, "Id", "FirstName");
        ...
        public async Task<IActionResult> Create([Bind("Id,PatientId,CreatorId,CreationDate,Note")] Files files)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(uint id, [Bind("Id,PatientId,CreatorId,CreationDate,Note")] Files files)
        {
            if (id != files.Id)
            {
                return NotFound();
