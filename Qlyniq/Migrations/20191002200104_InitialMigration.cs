        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeanId = table.Column<uint>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Gender = table.Column<string>(type: "enum('Male','Female')", nullable: false),
                    IsMedicalWorker = table.Column<sbyte>(type: "tinyint(1)", nullable: true, defaultValueSql: "'0'"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<uint>(nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    OfficeId = table.Column<uint>(nullable: false),
                    EmployeeId = table.Column<uint>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_deans", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Deans_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Deans_OfficeId",
                        column: x => x.OfficeId,
                        principalTable: "offices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Helicobacter = table.Column<sbyte>(type: "tinyint(1)", nullable: true, defaultValueSql: "'0'")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiagnosisId = table.Column<uint>(nullable: false),
                    Therapy = table.Column<string>(type: "varchar(500)", nullable: false, defaultValueSql: "'Nihil'"),
                    IsEmergency = table.Column<sbyte>(type: "tinyint(1)", nullable: true, defaultValueSql: "'0'"),
